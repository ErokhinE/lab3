...
function getRValue() {
   // const rText = $('.r-button.hvr-grow.active').next('label').text();
   // let rValue = parseFloat(rText);
    let rValueT = $('.r-button.hvr-grow.active').next('label').text();
    let rValue = parseFloat(rValueT);
